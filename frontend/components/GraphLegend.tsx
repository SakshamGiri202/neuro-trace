  ...
  return (
    <div className="absolute bottom-3 left-3 z-20 flex flex-col gap-1.5 bg-[var(--card)]/90 border border-[var(--border)] p-2.5 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[9px] font-mono text-[var(--muted-foreground)]">Malicious node</span>
      </div>
      <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[9px] font-mono text-[var(--muted-foreground)]">Malicious edge</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="w-4 h-0.5 bg-[#0000FF] shrink-0" />
        <span className="text-[9px] font-mono text-[var(--muted-foreground)]">Mixed edge</span>
      </div>
      <div className="flex items-center gap-2">
